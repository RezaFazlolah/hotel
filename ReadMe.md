=========================================================================================
[] auth
    [T] mapping strategy between enum UserRoles and its string equivalent
        [T] mapping between server and client?
        [T] mapping between server and DB?
    ...
    [T] registration
        [T] separate registration endpoint for admin who can specify user role, obviously this endpoint requires authorization
        [T] check for role existence before creating user, otherwise you end up with a user who has no role
    [] think about admin and manager controller endpoints. how should it be implemented? separate endpoints and controller or common?    
...
[] separate auth and app DbContext's
[] fix reservation controllers
